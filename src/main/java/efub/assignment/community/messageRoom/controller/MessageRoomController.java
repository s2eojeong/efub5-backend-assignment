...
public class MessageRoomController {
    ...
    //쪽지방 목록 조회
//    @GetMapping("")
//    public ResponseEntity<MessageRoomListResponseDTO> getMsgRoomList(@RequestHeader Long memberId) {
//        MessageRoomListResponseDTO responseDTO = messageRoomService.getMsgRoomList(memberId);
