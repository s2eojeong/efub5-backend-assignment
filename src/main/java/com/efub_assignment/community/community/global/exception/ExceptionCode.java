...
public enum ExceptionCode {
    ...
    // 401 Unauthorized
    POST_ACCOUNT_MISMATCH(HttpStatus.UNAUTHORIZED, ClientExceptionCode.POST_MEMBER_MISMATCH, "허용되지 않은 계정의 접근입니다."),

    // 404 Not Found
    ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, ClientExceptionCode.MEMBER_NOT_FOUND, "계정이 존재하지 않습니다."),
